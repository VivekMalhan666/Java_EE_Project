...
<div class="container" id="wrap">
 <div class="row">
        ...
        <div class="col-md-3">
            <form action="VolunteerChangePasswordController" method="post" accept-charset="utf-8" class="form" role="form" style="color:white; margin-top:50px; margin-top:-560px"><h3>Change Password Form</h3>
