            ...
            <div class="gender"><label>Gender :</label>${volunteerObj.gender}</div>
             <div class="qualification"><label>Qualification :</label>${volunteerObj.qualification}</div>
              <div class="jobpost"><label>Job Post :</label>${volunteerObj.jobPost}</div>
               ...
               <%-- <a href="RejectedVolunteer?email=${volunteerObj.emailId}" class="btn btn-primary">Reject</a> --%>
        </div>
					<!--<tr>
					<td><img src="images/${volunteerObj.photo}.jpg" style="height:100px;width:100px"/></td>
						<td>${volunteerObj.name}</td>
						<td>${volunteerObj.address}</td>
						<td>${volunteerObj.city}</td>
						<td>${volunteerObj.state}</td>
						<td>${volunteerObj.mobileNo}</td>
						<td>${volunteerObj.gender}</td>
						<td>${volunteerObj.qualification}</td>
						<td>${volunteerObj.jobPost}</td>
