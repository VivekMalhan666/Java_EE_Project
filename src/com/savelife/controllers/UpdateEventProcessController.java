...
@WebServlet("/updateEventProcess")
@MultipartConfig(maxFileSize = 16177215)
public class UpdateEventProcessController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean r=daoObj.updateEvent(eventObj);
		if(r){
			List<Events> eventList=daoObj.getAllEvents();

			request.setAttribute("eList",eventList);

			request.setAttribute("msg","Details of Events Updated Succesfully");
