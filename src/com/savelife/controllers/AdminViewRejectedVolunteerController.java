...
@WebServlet("/AdminViewRejectVolunteer")
public class AdminViewRejectedVolunteerController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<com.savelife.models.Volunteer> volunteerList=daoObj.getRejectedVolunteer();
